...
main_boosting_data<-function(fold=1,train_portion=0.5,testcode=0,traincode=0){
         ...
         subTrain2$visitor_hist_starrating<-subTrain2$visitor_hist_starrating-subTrain2$prop_starrating
         subTrain2$visitor_hist_starrating[is.na(subTrain2$visitor_hist_starrating)]<-
                                           min(subTrain2$visitor_hist_starrating,na.rm=T)-1
          ...
          subTrain2$visitor_hist_adr_usd<-subTrain2$visitor_hist_adr_usd-subTrain2$price_usd
          subTrain2$visitor_hist_adr_usd[is.na(subTrain2$visitor_hist_adr_usd)]<-
                                           min(subTrain2$visitor_hist_adr_usd,na.rm=T)-1
          ...
          subTrain2$prop_log_historical_price[ subTrain2$prop_log_historical_price==0]<-
                                        subTrain2$price_usd[ subTrain2$prop_log_historical_price==0]+price_diff+1
...
xTemp2 <- matrix(0,ncol=length(names_context_diff),nrow=nrow(XData))
  ...
  write.svmlight(labels,data.matrix(XData),file='test_data1')
