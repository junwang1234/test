	...
	main_boosting_data<-function(fold=1,train_portion=0.5,testcode=0,traincode=0){
	 ...
	 # visitor_hist_starrating--> emphasize the strong match signal
         ...
         subTrain2$visitor_hist_starrating2 <- subTrain2$visitor_hist_starrating
         ...
         subTrain2$visitor_hist_starrating2 <- abs( subTrain2$prop_starrating - subTrain2$visitor_hist_starrating2 )
         subTrain2$visitor_hist_starrating2[is.na(subTrain2$visitor_hist_starrating2)] <-max(subTrain2$visitor_hist_starrating2,na.rm=T)+1
	  ...
	  subTrain2$price_usd<-log10( subTrain2$price_usd+1e-8)  
          ...
          subTrain2$visitor_hist_adr_usd2 <- subTrain2$visitor_hist_adr_usd
          subTrain2$visitor_hist_adr_usd2 <- abs( subTrain2$price_usd - subTrain2$visitor_hist_adr_usd2 )
          subTrain2$visitor_hist_adr_usd2[is.na(subTrain2$visitor_hist_adr_usd2)]<-
                                                               max(subTrain2$visitor_hist_adr_usd2,na.rm=T)+1
	   ...
	   subTrain2$prop_review_score_bool <- rep(0,nrow(subTrain2))
           subTrain2$prop_review_score_bool[is.na(subTrain2$prop_review_score)] <- 1
           ...
           subTrain2$prop_review_score2[is.na( subTrain2$prop_review_score2)]<-
                                                           max(subTrain2$prop_review_score2,na.rm=T) + 1
           ...
           subTrain2$prop_location_score2_bool <- rep(0,nrow(subTrain2))
           subTrain2$prop_location_score2_bool[is.na(subTrain2$prop_location_score2)] <- 1
	  ...
	  #srch_booking_window
          ...
          #added feature
           ...
           subTrain2$prop_log_historical_price_bool <- rep(0,nrow(subTrain2))
           subTrain2$prop_log_historical_price_bool[subTrain2$prop_log_historical_price==0] <- 1

          subTrain2$prop_log_historical_price2 <- subTrain2$prop_log_historical_price
          subTrain2$prop_log_historical_price3 <- subTrain2$prop_log_historical_price

          price_diff<- min(subTrain2$prop_log_historical_price3[subTrain2$prop_log_historical_price3!=0]
                          -subTrain2$price_usd[subTrain2$prop_log_historical_price3!=0])

          subTrain2$prop_log_historical_price3[ subTrain2$prop_log_historical_price3==0]<-
                           subTrain2$price_usd[ subTrain2$prop_log_historical_price3==0]+price_diff-1

          subTrain2$prop_log_historical_price3 <-subTrain2$prop_log_historical_price3-subTrain2$price_usd


          price_diff<- max(subTrain2$prop_log_historical_price2[subTrain2$prop_log_historical_price2!=0]
 ...
 print('Competitor feature  finished')
  ...
  names_remained<-c('prop_brand_bool','promotion_flag','orig_destination_distance',
		    'comp1_rate','comp2_rate','comp3_rate','comp4_rate',
                    ...
                    'prop_location_score1','prop_location_score2','prop_location_score2_bool',
		   'prop_starrating','prop_review_score','prop_review_score2','prop_review_score_bool', 
                    'visitor_hist_starrating','visitor_hist_starrating2','visitor_hist_starrating_bool',
                     'visitor_hist_adr_usd','visitor_hist_adr_usd2','visitor_hist_adr_usd_bool',
		   'prop_log_historical_price', 'prop_log_historical_price2','prop_log_historical_price3',
                   'prop_log_historical_price_bool',
  ...
  names_context_diff<-c('prop_brand_bool','promotion_flag','orig_destination_distance',
                   ...
                   'prop_starrating','prop_review_score','prop_review_score2',
                    'visitor_hist_starrating','visitor_hist_starrating2',
                     'visitor_hist_adr_usd','visitor_hist_adr_usd2',
                   'prop_log_historical_price', 'prop_log_historical_price2','prop_log_historical_price3',
                    'price_usd','srch_query_affinity_score'
